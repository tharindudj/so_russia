...
credits() // 640x480 
{
	...
	info[0]["hud"] = addIconHud( level, 290, 40+addY, 0, "so_hud_medals_deaths", 70, 70 );
	info[0]["hud"].sort = -1;
	info[1]["hud"] = addIconHud( level, 290, 40+addY, 0, "so_hud_medals_score", 70, 70 );
	info[1]["hud"].sort = -1;
	info[2]["hud"] = addIconHud( level, 290, 40+addY, 0, "so_hud_medals_assists", 70, 70 );
	info[2]["hud"].sort = -1;
	info[3]["hud"] = addIconHud( level, 290, 40+addY, 0, "so_hud_medals_kills", 70, 70 );
	info[3]["hud"].sort = -1;
	info[4]["hud"] = addIconHud( level, 290, 40+addY, 0, "so_hud_medals_suicides", 70, 70 );
	info[4]["hud"].sort = -1;
	
	info[5]["hud"] = addIconHud( level, 290, 150+addY, 0, "so_hud_medals_nade_killer", 70, 70 );
	info[5]["hud"].sort = -1;
	info[6]["hud"] = addIconHud( level, 290, 150+addY, 0, "so_hud_medals_knife_killer", 70, 70 );
	info[6]["hud"].sort = -1;
	info[7]["hud"] = addIconHud( level, 290, 150+addY, 0, "so_hud_medals_plants", 70, 70 );
	info[7]["hud"].sort = -1;
	info[8]["hud"] = addIconHud( level, 290, 150+addY, 0, "so_hud_medals_headshots", 70, 70 );
	info[8]["hud"].sort = -1;
	info[9]["hud"] = addIconHud( level, 290, 150+addY, 0, "so_hud_medals_defuses", 70, 70 );
	info[9]["hud"].sort = -1;
