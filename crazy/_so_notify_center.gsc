...
init()
{
    ...
    level.notifyCards = [];
	level.notifyCards[0] = "so_notify_clan";
	level.notifyCards[1] = "so_notify_facebook";
	level.notifyCards[2] = "so_notify_new";
	level.notifyCards[3] = "so_notify_screenshots";
	level.notifyCards[4] = "so_notify_warn";
	level.notifyCards[5] = "so_notify_instagram";
	level.notifyCards[6] = "so_notify_music";
	level.notifyCards[7] = "so_notify_teamspeak";
	level.notifyCards[8] = "so_notify_youtube";
	level.notifyCards[9] = "so_notify_donates";
