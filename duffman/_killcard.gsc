...
init() {
	...
	addDesign("default",0,(1.0,0.0,0.0),0.6,"white",252,42,"middle",185);
	addDesign("default",2,(1.0,0.0,0.0),0.1,"white",0,0,"middle",185);
 	addDesign("default",1,(1.0,0.0,0.0),0.8,"nightvision_overlay_goggles",250,42,"middle",185);
