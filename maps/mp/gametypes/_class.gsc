...
giveLoadout(team, class)
{
	...
	if (self.pers[class]["loadout_grenade"] != "none" && (getDvarInt("weap_allow_flash_grenade") || getDvarInt("weap_allow_smoke_grenade") || getDvarInt("weap_allow_throwingknife") ) )
	{
		if (self.pers[class]["loadout_grenade"] == "flash_grenade" && getDvarInt("weap_allow_flash_grenade")) self setOffhandSecondaryClass("flash");
		else if (self.pers[class]["loadout_grenade"] == "smoke_grenade" && getDvarInt("weap_allow_smoke_grenade")) self setOffhandSecondaryClass("smoke");
		else if (self.pers[class]["loadout_grenade"] == "throwingknife" && getDvarInt("weap_allow_throwingknife")) self setOffhandSecondaryClass("throwingknife");
...
sidearmWeapon()
{
	...
	if (sidearmWeapon != "none" && sidearmWeapon != "deserteaglegold" && sidearmWeapon != "deserteagle" && sidearmWeapon != "colt45" && sidearmWeapon != "usp" && sidearmWeapon != "beretta" && sidearmWeapon != "knife") sidearmWeapon = getDvar("class_" + class + "_secondary");
	if (sideArmWeapon != "none")
	{
		if (self.pers[class]["loadout_secondary_attachment"] == "silencer") sidearmWeapon = sidearmWeapon + "_silencer_mp";
		else
		{
...
primaryWeapon()
{
	...
	if (primaryWeapon != "none" && primaryWeapon != "m16" && primaryWeapon != "ak47" && primaryWeapon != "m4" && primaryWeapon != "g3" && primaryWeapon != "g36c" && primaryWeapon != "m14" && primaryWeapon != "mp44" && primaryWeapon != "mp5" && primaryWeapon != "uzi" && primaryWeapon != "ak74u" && primaryWeapon != "winchester1200" && primaryWeapon != "m1014" && primaryWeapon != "m40a3" && primaryWeapon != "remington700") primaryWeapon = getDvar("class_" + class + "_primary");
	if (!isDefined(self.pers[class]["loadout_camo"])) self.pers[class]["camo_num"] = 0;
	else if (self.pers[class]["loadout_camo"] == "camo_brockhaurd") self.pers[class]["camo_num"] = 1;
	else if (self.pers[class]["loadout_camo"] == "camo_bushdweller") self.pers[class]["camo_num"] = 2;
	else if (self.pers[class]["loadout_camo"] == "camo_blackwhitemarpat") self.pers[class]["camo_num"] = 3;
	else if (self.pers[class]["loadout_camo"] == "camo_tigerred") self.pers[class]["camo_num"] = 4;
	else if (self.pers[class]["loadout_camo"] == "camo_stagger") self.pers[class]["camo_num"] = 5;
    else if ((self.pers[class]["loadout_camo"] == "camo_gold" || self.pers[class]["loadout_camo"] == "camo_diamond") && (primaryWeapon == "ak47" || primaryWeapon == "uzi" || primaryWeapon == "m1014" || (primaryWeapon == "m40a3" && roundspl >= 1000) || (primaryWeapon == "ak74u" && roundspl >= 2000 )))
	...
	{
		if (self.pers[class]["loadout_primary_attachment"] == "silencer") primaryWeapon = primaryWeapon + "_silencer_mp";
		else
		{
