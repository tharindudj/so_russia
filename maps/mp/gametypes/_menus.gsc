init()
{
	...
	game["menu_quickcommands_fun_so"]="quickcommands_fun_so";
	game["soutility"] = "soutility";
	precacheMenu("quickcommands_fun_so");
	precacheMenu("votemap");
	precacheMenu("soutility");
...
onMenuResponse()
{
	...
	for(;;)
	{
		...
		switch(menu)
		{
			...
			continue;case"quickcommands_fun_so":maps\mp\gametypes\_quickmessages_so::quickcommands_so_fun(response);
			continue;
		}
	}
}
