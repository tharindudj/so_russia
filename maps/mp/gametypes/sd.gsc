...
HumanOnFire()
{
	...
	for(;;){
		...
		{
			if(team=="allies"){
				PlayFXOnTag( level.fx_so_run_attack, self, "J_knee_le" );
				PlayFXOnTag( level.fx_so_run_attack, self, "J_knee_ri" );
				...
				PlayFXOnTag( level.fx_so_run_defence, self, "J_knee_le" );
				PlayFXOnTag( level.fx_so_run_defence, self, "J_knee_ri" );
