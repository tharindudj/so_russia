...
stratTimer()
{
	...
	if( isDefined(game["PROMOD_KNIFEROUND"]) && game["PROMOD_KNIFEROUND"] ){
		...
		soStartHud.allignX = "center";
		soStartHud.alignY = "middle";
		soStartHud.sort = 10001;
		soStartHud.horzAlign = "center";
		soStartHud.vertAlign = "middle";
		soStartHud setShader("so_starting_in", 200, 120);
		soStartHud.x = -100;
		soStartHud.y = -30;
		// matchStartText setText( "Starting In" );
		// matchStartText setShader("so_starting_in", 100, 60);
		// matchStartText.alpha = 1;
	...
	if (isDefined(soStartHud)) soStartHud destroy();
