main()
{
	...
	setDvar( "scr_dom_timelimit", 64 ); // [0->] (minutes)
	...
	setDvar( "scr_koth_timelimit", 64 ); // [0->] (minutes)
	...
	setDvar( "scr_war_timelimit", 64 ); // [0->] (minutes)
	...
	// website
	setDvar( "promod_hud_website", "^1SO RUSSIA PROMOD" ); // (avoid "//" here)
